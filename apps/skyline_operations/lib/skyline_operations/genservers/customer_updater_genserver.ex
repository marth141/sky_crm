defmodule SkylineOperations.HubspotDealToNetsuiteCustomerRefresher do
  @moduledoc """
  ...
  def refresh_cache() do
    SkylineOperations.update_netsuite_customers_with_finance_fees_and_cash_price()

    IO.puts("\n \n ======= Refreshed Netsuite Customers with Hubspot Info ======= \n \n")
    :ok
  end
end
