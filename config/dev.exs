...
# Change from Local to Gmail if you really want to test
config :emailing, :mailer, adapter: Swoosh.Adapters.Local

config :sighten_api, client_url: "https://onboard.goeverbright.com/"
